(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'DD-MM-YYYY', minDate: null, maxDate: null, currentDate: null, lang: 'ru', weekStart: 1, disabledDays: [], shortTime: false, clearButton: false, nowButton: false, cancelText: 'Отмена', okText: 'OK', clearText: 'Сброс', nowText: 'Сейчас', switchOnClick: false, triggerEvent: 'focus', monthPicker: false, year:true};
